...
?>
    ...
    <form name="formDelete" method="POST" action="">
        ...
        <?php foreach ($rows as $row): ?>
                            ...
                            <dt class="col-sm-3">Jumlah:</dt><dd class="col-sm-9"><?php echo $row['jumlah']; ?></dd>

                            <dt class="col-sm-3">Jenis_transaksi:</dt><dd class="col-sm-9"><?php echo $row['jenis_transaksi']; ?></dd>

                            <dt class="col-sm-3">Tanggal:</dt><dd class="col-sm-9"><?php echo $row['tanggal']; ?></dd>
